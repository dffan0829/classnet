						...
						<div class="u_form1">
							<div style="text-align: center">
								<table width="100%" border="0" cellpadding="5" cellspacing="0">
									<tr align="center">
										<td id="TabTitle0" class="titlemouseover">教师信息</td>
									</tr>
								</table>
								<form action="<%=request.getContextPath()%>/teacher/teacherOperate.do?m=updateInfo"
									...
									<table width="100%" border="0" cellpadding="5" cellspacing="1" id="regtable"
										...
										<tr>
											<td align="right" width="20%">教师姓名:</td>
											<td align="left"><input name="realName"
												value="${userEntity.realName}" /></td>
										</tr>
										<tr>
											<td align="right" width="20%">教师联系电话:</td>
										...
										<tr>
											<td align="right">所在名称:</td>
											<td align="left"><c:out value="${grade.className}" /></td>
										</tr>
										<tr>
											<td align="right">班级人数:</td>
											<td align="left"><c:out value="${grade.classNum}" /></td>
										</tr>
