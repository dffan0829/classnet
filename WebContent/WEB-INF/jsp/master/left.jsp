...
<div id="content_1">
<ul>
<li><a href="<c:url value="/master/" />"><img align="absmiddle" src="<f:message key="image_http_url"/>/images/article_add.gif" style="border: 0" />&nbsp;&nbsp;学生信息</a></li>
...
<li><a href="<c:url value="/master/student.do?m=signIn" />"><img align="absmiddle" src="<f:message key="image_http_url"/>/images/article_add.gif" style="border: 0" />&nbsp;&nbsp;个人签到</a></li>
</ul>
</div>