	...
	<div class="content">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td valign="top">
					<div class="right">
						<form action="<c:url value="/admin/grade.do?m=doAddGrade"/>"
							...
							<table width="80%" border="0" cellpadding="0" cellspacing="1"
								...
								<tr>
									...
									<td height="28" bgcolor="#FFFFFF"><c:choose>
											<c:when test="${empty grade}">
												<input type="text" name="classid" id="classid"
													value="${grade.classId}" maxlength="10" />
												<p>请输入班级编号</p>
											</c:when>
											<c:otherwise>
												<input type="text" name="classid" id="classid" r
													value="${grade.classId}" maxlength="10" />
												<p>请输入班级编号</p>
											</c:otherwise>
										</c:choose></td>
								...
								<tr>
									...
									<td height="28" bgcolor="#FFFFFF"><input type="text"
										name="classname" id="classname" value="${grade.className}"
										maxlength="10" />
									<p>请输入班级名称</p></td>
								</tr>
								<tr>
									...
									<td height="28" bgcolor="#FFFFFF"><input type="text"
										name="classnum" id="classnum" value="${grade.classNum}"
										maxlength="10" />
									<p>请输入班级人数</p></td>
								</tr>
								<tr>
									...
									<td height="28" bgcolor="#FFFFFF"><c:choose>
											...
											<c:otherwise>
												 <input type="hidden" name="teacherid" value="${userEntity.id}"/>
												 ${userEntity.realName}
											</c:otherwise>
										</c:choose>
									</td>
							...
							<div class="anniu">
								<p>
									...
									<input type="button" value="返回" class="fabu" onclick="javascript:window.history.go(-1)"/>
								</p>
